...
// useState lets you define and update state in functional components
//React handles rendering, but useEffect is used for anything happening
//outside the React rendering process (e.g., API calls, subscriptions, timers).
...
import { CircularProgress } from "@mui/material"; //UI design 
